...
import { s as Et } from "./chunks/paths-28a87002.js";
function F(n) {
    let t, e, s;
    const r = [n[2] || {}];
    var a = n[0][1];
...
function Z(n) {
    ...
    return {
        ...
        l(s) {
            t = ht(s, "DIV", { id: !0, "aria-live": !0, "aria-atomic": !0, class: !0 });
            var r = dt(t);
...
const qt = "modulepreload",
    et = {},
    Ut = "/tadhgwhitemu.github.io/_app/",
    j = function (t, e) {
        return !e || e.length === 0
            ? t()
            : Promise.all(
    ...
    p = [
        () =>
            j(
                ...
                [
                    ...
                    "assets/pages/__layout.svelte-b0c26517.css",
        ...
        () =>
            j(
                () => import("./pages/index.svelte-f1533e9b.js"),
                ["pages/index.svelte-f1533e9b.js", "chunks/vendor-40075b22.js"]
            ),
        () =>
            j(
                () => import("./pages/projects/index.svelte-ce9fcebe.js"),
                [
                    "pages/projects/index.svelte-ce9fcebe.js",
                    "chunks/vendor-40075b22.js",
                    "chunks/paths-28a87002.js",
                ]
            ),
        () =>
            j(
...
class Tt {
    ...
    init_listeners() {
        ...
        const e = (a) => {
            const i = st(a.target);
            i && i.href && i.hasAttribute("sveltekit:prefetch") && this.prefetch(rt(i));
        };
        let s;
        const r = (a) => {
            clearTimeout(s),
...
class Vt {
    constructor({ Root: t, fallback: e, target: s, session: r, host: a }) {
        (this.Root = t),
            ...
            (this.stores = { page: Ct({}), navigating: W(null), session: W(r) }),
            (this.$session = null),
            (this.root = null);
        let i = !1;
        ...
        try {
            for (let c = 0; c < s.length; c += 1) {
                ...
                if ((a.push(f), f && f.loaded))
                    ...
                    } else f.loaded.stuff && (i = R(R({}, i), f.loaded.stuff));
            }
            o = l
            ...
            if (e) throw c;
            o = await this._load_error({ status: 500, error: it(c), path: r.path, query: r.query });
        }
        if (o.redirect) {
            ...
            const { started: c } = this,
                u = {
                    ...
                    fetch(h, k) {
                        ...
                        return i.uses.dependencies.push(A), c ? fetch(h, k) : Nt(h, k);
                    },
                };
            e && ((u.status = t), (u.error = e));
            const f = await s.load.call(null, u);
            if (!f) return;
            (i.loaded = It(f)), i.loaded.stuff && (i.stuff = i.loaded.stuff);
        }
        return i;
    }
    async _load({ route: t, info: { path: e, decoded_path: s, query: r } }, a) {
        ...
        t: for (let d = 0; d < l.length; d += 1) {
            ...
            } else _ && _.loaded && _.loaded.stuff && (A = R(R({}, A), _.loaded.stuff)), v.push(_);
        }
...
async function Jt({
    ...
    const l = new Vt({ Root: Lt, fallback: At, target: t, session: e, host: s }),
        c = r ? new Tt({ base: n.base, routes: jt, trailing_slash: i, renderer: l }) : null;
    Et(n),
        o && (await l.start(o)),
